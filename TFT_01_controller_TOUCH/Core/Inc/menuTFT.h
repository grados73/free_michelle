...
#define DAY_CHECK_RELAY_BUTTON_SPACE 5
#define DAY_CHECK_RELAY_BUTTON_Y 200

#define DAY_CHECK_RELAY_BUTTON_1_X 20
#define DAY_CHECK_RELAY_BUTTON_2_X (DAY_CHECK_RELAY_BUTTON_1_X + DAY_CHECK_BUTTON_W + DAY_CHECK_RELAY_BUTTON_SPACE)
#define DAY_CHECK_RELAY_BUTTON_3_X (DAY_CHECK_RELAY_BUTTON_1_X + DAY_CHECK_BUTTON_W + DAY_CHECK_RELAY_BUTTON_SPACE)
#define DAY_CHECK_RELAY_BUTTON_4_X (DAY_CHECK_RELAY_BUTTON_1_X + DAY_CHECK_BUTTON_W + DAY_CHECK_RELAY_BUTTON_SPACE)
#define DAY_CHECK_RELAY_BUTTON_5_X (DAY_CHECK_RELAY_BUTTON_1_X + DAY_CHECK_BUTTON_W + DAY_CHECK_RELAY_BUTTON_SPACE)
#define DAY_CHECK_RELAY_BUTTON_6_X (DAY_CHECK_RELAY_BUTTON_1_X + DAY_CHECK_BUTTON_W + DAY_CHECK_RELAY_BUTTON_SPACE)
#define DAY_CHECK_RELAY_BUTTON_7_X (DAY_CHECK_RELAY_BUTTON_1_X + DAY_CHECK_BUTTON_W + DAY_CHECK_RELAY_BUTTON_SPACE)
#define DAY_CHECK_RELAY_BUTTON_8_X (DAY_CHECK_RELAY_BUTTON_1_X + DAY_CHECK_BUTTON_W + DAY_CHECK_RELAY_BUTTON_SPACE)
#define DAY_CHECK_RELAY_BUTTON_9_X (DAY_CHECK_RELAY_BUTTON_1_X + DAY_CHECK_BUTTON_W + DAY_CHECK_RELAY_BUTTON_SPACE)
